...
function BaseIcon({
  ...
  return (
    ...
    >
      <circle cx="32" cy="32" r="28" fill={background} />
      {children}
    </svg>
  );
}
...
export default function DimensionIcon({
  ...
  if (category === 'intellectual') {
    return (
      <BaseIcon className={className} background="#F7FAE8">
        <path
          ...
          fill="#BFD46B"
        />
        <rect x="27.5" y="43.5" width="9" height="3.5" rx="1.75" fill="#8BA23F" />
        <rect x="28.5" y="48" width="7" height="3" rx="1.5" fill="#6E8232" />
        <path
  ...
  return (
    <BaseIcon className={className} background="#FFF7E8">
      <path
